...
(def players {
    ...
    {:id 11 :alliance "OWA" :team "Human" :race "Ogre"  :position "" :skills [ :juggernaut ] :abilities [ :tackle :cheat ] :spp [ 4 2 ]}
    ; elf 12-23
    ; dwarf 24-35
    ; freebooter 36-61
    ...
    {:id 106 :alliance "CWC" :team "Orc" :race "Black Orc" :position "Blocker" :skills [ :frenzy ] :abilities [ :tackle ] :spp [ 3 1 ]}
    {:id 107 :alliance "CWC" :team "Orc" :race "Black Orc" :position "Blocker" :skills [ :frenzy ] :abilities [ :tackle ] :spp [ 3 1 ]}
    ...
    {:id 111 :alliance "CWC" :team "Orc" :race "Da Troll" :position "" :skills [ :pilingon ] :abilities [ :tackle :cheat ] :spp [ 4 2 ]}
    ; chaos 112-123
    ; skaven 124-135
    ; freebooter 136-161
})
