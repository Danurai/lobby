...
(def data (atom {
  :mages [
    ...
    {:id 4 :name "Artificer"   :type "mage"                                       :action [{:reducer true :reduction {:any 1 :restrict #{"artifact"} :exclude #{:gold}}}]}
  ...
  :magicitems [
    ...
    {:id 4 :name "Protection"     :type "magicitem" :action [{:react :loselife :turn true}]}
  ...
  :placesofpower [
    ...
    {:id 0 :base 6 :name "Alchemists Tower"      :type "pop" :cost {:gold 3} :collect [{:any 3 :exclude #{:gold}}] :action [{:cost {:death 1 :elan 1 :calm 1 :life 1} :place {:gold 1}} {:react :loselife :turn true}] :vp 0}
    ...
    {:id 2 :base 2 :name "Coral Castle"          :type "pop" :fg? true :cost {:elan 3 :life 3 :calm 3 :death 3} :action [{:turn true :checkvictory true}{:react :loselife :turn true}] :vp 3}
    {:id 9 :base 2 :name "Sunken Reef"           :type "pop" :cost {:calm 5 :elan 2 :life 2} :collect [{:gold 1}] :action [{:cost {:calm 2 :life 2} :place {:life 1}}] :vp 0}
    ...
    {:id 8 :base 4 :name "Sorcerer's Bestiary"   :type "pop" :cost {:life 4 :elan 2 :calm 2 :death 2} :action [{:turn true :checkvictory true}{:turn 2 :cost {:any 4} :playfromanydiscard true} ] :vp 0}
  ]
  ...
  :artifacts [
    ...
    {:id 9  :type "artifact" :name "Dragon Bridle"        :cost {:elan 1 :life 1 :calm 1 :death 1} :action [{:special 9} {:react true :turn true :ignore :dragonpower}] :vp 1}
    ...
    {:id 31 :type "artifact" :name "Ring of Midas"        :cost {:life 1 :gold 1} :vp 1}
    {:id 32 :type "artifact" :name "Sacrificial Dagger"   :cost {:death 1 :gold 1} :action [{:turn true :cost {:life 1} :place {:death 3}} {}] }
    {:id 33 :type "artifact" :name "Sea Serpent"          :cost {:calm 6 :life 3} :subtype "Dragon Creature" :vp 1}
    ...
    {:id 37 :type "artifact" :name "Water Dragon"         :cost {:calm 6} :subtype "Dragon" :vp 1}
    {:id 38 :type "artifact" :name "Wind Dragon"          :cost {:calm 4 :any 4} :subtype "Dragon" :vp 1}
